...
class _PriceRangeState extends State<PriceRange> {
  ...
  RangeValues _currentRatingValues = const RangeValues(7.0, 9.0);
  ...
  void filteredSearchButton() {
    ...
    ranges[0] = double.parse((_currentRatingValues.start).toStringAsFixed(2));
    ranges[1] = double.parse((_currentRatingValues.end).toStringAsFixed(2));
    ranges[2] = double.parse((_currentRangeValues.start).toStringAsFixed(2));
    ranges[3] = double.parse((_currentRangeValues.end).toStringAsFixed(2));
  }
